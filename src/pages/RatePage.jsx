                ...
                <div className="content content_rate">
                    <div className="public_tab rate_tab container-back">
                        <ul>
                            ...
                            <TabButton id={0} isActive={activeTab === 0} setActiveTab={setActiveTab} DataFeather={Star} >Тарифы</TabButton>
                            <TabButton id={2} isActive={activeTab === 2} setActiveTab={setActiveTab} DataFeather={Move} >Работа с API</TabButton>
                        </ul>
                    </div>
            ...
            : location?.state?.work ?
                <div className="content-page ">
                    <div className="content">
                        <div className="public_tab rate_tab container-back">
                            <ul>
                                <TabButton id={2} isActive={activeTab === 2} setActiveTab={setActiveTab} DataFeather={Settings} >Настройки</TabButton>
                                <TabButton id={1} isActive={activeTab === 1} setActiveTab={setActiveTab} DataFeather={Star} >Тарифы</TabButton>
                                <TabButton id={0} isActive={activeTab === 0} setActiveTab={setActiveTab} DataFeather={Move} >Работа с API</TabButton>
                            </ul>
                        </div>
                ...
                <div className="content-page ">
                    <div className="content">
                        <div className="public_tab rate_tab container-back">
                            <ul>
                                <TabButton id={0} isActive={activeTab === 0} setActiveTab={setActiveTab} DataFeather={Settings} >Настройки</TabButton>
                                <TabButton id={1} isActive={activeTab === 1} setActiveTab={setActiveTab} DataFeather={Star} >Тарифы</TabButton>
                                <TabButton id={2} isActive={activeTab === 2} setActiveTab={setActiveTab} DataFeather={Move} >Работа с API</TabButton>
                            </ul>
                        </div>
