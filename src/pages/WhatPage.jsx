                    ...
                    <div className="what_block">
                        ...
                        <div className="what_is_content">
                            <div className="what_is_content_item">
                                ...
                                <div className="ans">Предварительную версию ChatGPT можно использовать бесплатно.</div>
                            </div>
                            <div className="what_is_content_item">
                                <div className="ques">2. Как работает ChatGPT?</div>
                                <div className="ans">ChatGPT создан на основе GPT-3.5, языковой модели, обученной для создания текста.
