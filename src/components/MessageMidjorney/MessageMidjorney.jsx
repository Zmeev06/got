                ...
                {midjData.type === "image" &&
                        midjData.messages[0] &&
                            <div className="midjourney_chat">
                                <img className="chat_code_img" src={midjData.messages[0].result} alt=""/>
                                ...
                                <input type="text" name="a4" id="a_four" value="A4" /> */}
                                            <a href="#" className="midjourney_chat_item">V1</a>
                                            <a href="#" className="midjourney_chat_item">V2</a>
                                            <a href="#" className="midjourney_chat_item">V3</a>
                                            <a href="#" className="midjourney_chat_item">V4</a>
                                            <a href="#" className="midjourney_chat_item">U5</a>
                                            <a href="#" className="midjourney_chat_item">U6</a>
                                            <a href="#" className="midjourney_chat_item">U7</a>
                                            <a href="#" className="midjourney_chat_item">U8</a>
                                        </div>
                                        <button className="midjourney_chat_btn">Выбрать</button>
                                    </form>
                                </div>
